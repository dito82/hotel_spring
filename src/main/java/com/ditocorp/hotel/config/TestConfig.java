...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Reserva r1 = new Reserva(null, "1001", Instant.parse("2019-06-20T19:53:07Z"), c1, ReservaStatus.CASAL);
		Reserva r2 = new Reserva(null, "1002", Instant.parse("2019-07-21T03:42:10Z"), c2, ReservaStatus.GRUPO);
		Reserva r3 = new Reserva(null, "1001", Instant.parse("2019-07-22T15:21:22Z"), c1, ReservaStatus.GRUPO);
